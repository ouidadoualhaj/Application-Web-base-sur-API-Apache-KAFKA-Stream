...
consumer = KafkaConsumer('test3', bootstrap_servers='localhost:9092', group_id='group_id', value_deserializer=lambda x: json.loads(x.decode('utf-8')))
...
def predict():
    ...
    if not prediction_in_progress:
        ...
        producer.send('test3', value=form_data)
